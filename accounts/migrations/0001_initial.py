    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='USD', help_text='Preferred currency for budgets', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_fund_goal', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('default_budget_period', models.CharField(choices=[('weekly', 'Weekly'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], default='monthly', max_length=20)),
